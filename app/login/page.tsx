...
export default function LoginPage() {
  // Independent states for each login button
  ...
  const handleRegularLogin = async () => {
    if (regularLoginLoading || githubLoginLoading) return // Prevent action if either is loading
    ...
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="w-full max-w-md space-y-8 p-6">
        <div className="text-center">
          <Logo className="w-16 h-auto mx-auto mb-6 text-foreground" />
        ...
        <div className="space-y-4">
          ...
          <Button
            ...
            disabled={regularLoginLoading || githubLoginLoading}
          >
            {regularLoginLoading ? (
